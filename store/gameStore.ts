...
// Google's public STUN servers are reliable for most home networks (Cone NAT).
// For strict corporate networks (Symmetric NAT), a TURN server would be required (not free).
const PEER_CONFIG = {
  config: {
    iceServers: [
